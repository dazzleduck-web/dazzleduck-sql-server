       ...
       String base64SecretKey = appConfig.getString(ConfigConstants.SECRET_KEY_KEY);
        ...
        var cors = CorsSupport.builder()
                .addCrossOrigin(CrossOriginConfig.builder()
                        .allowOrigins(httpConfig.hasPath(CONFIG_ALLOW_ORIGIN) ? httpConfig.getStringList(CONFIG_ALLOW_ORIGIN).toArray(new String[0]) : new String[]{CORS_DEFAULT_ALLOW_ORIGIN})
